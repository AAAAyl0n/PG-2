def compare_arrays(arr1, arr2):
    ...
    if len(arr1) != len(arr2):
        return {
            "same": False,
            "reason": f"数组长度不同: arr1长度={len(arr1)}, arr2长度={len(arr2)}",
            "differences": []
        }
...
def print_comparison_result(result):
    ...
    if result["same"]:
        ...
        if "reason" in result:
            ...
            print(f"共有 {result['total_differences']} 个不同位置:")
            for diff in result["differences"]:
                print(f"  索引 {diff['index']}: arr1[{diff['index']}] = {diff['arr1_value']}, arr2[{diff['index']}] = {diff['arr2_value']}")

# 示例用法
if __name__ == "__main__":
    # 测试用例1: 相同的数组
    arr1 = [0xc8, 0x2e, 0x00, 0x2e, 0x80, 0x2e, 0x3d, 0xb1, 0xc8, 0x2e, 0x00, 0x2e, 0x80, 0x2e, 0x91, 0x03, 0x80, 0x2e, 0xbc,
    ...
    arr2 = [0xc8, 0x2e, 0x00, 0x2e, 0x80, 0x2e, 0x3d, 0xb1, 0xc8, 0x2e, 0x00, 0x2e, 0x80, 0x2e, 0x91, 0x03, 0x80, 0x2e, 0xbc,
  0xb0, 0x80, 0x2e, 0xa3, 0x03, 0xc8, 0x2e, 0x00, 0x2e, 0x80, 0x2e, 0x00, 0xb0, 0x50, 0x30, 0x21, 0x2e, 0x59, 0xf5,
  0x10, 0x30, 0x21, 0x2e, 0x6a, 0xf5, 0x80, 0x2e, 0x3b, 0x03, 0x00, 0x00, 0x00, 0x00, 0x08, 0x19, 0x01, 0x00, 0x22,
  0x00, 0x75, 0x00, 0x00, 0x10, 0x00, 0x10, 0xd1, 0x00, 0xb3, 0x43, 0x80, 0x2e, 0x00, 0xc1, 0x80, 0x2e, 0x00, 0xc1,
  0x80, 0x2e, 0x00, 0xc1, 0x80, 0x2e, 0x00, 0xc1, 0x80, 0x2e, 0x00, 0xc1, 0x80, 0x2e, 0x00, 0xc1, 0x80, 0x2e, 0x00,
  ...
  0x2e, 0x00, 0xc1]
    print("测试1 - 相同数组:")
    result1 = compare_arrays(arr1, arr2)
    print_comparison_result(result1)
    print()
